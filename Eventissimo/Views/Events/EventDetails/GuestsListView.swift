        ...
        NavigationView {
            VStack {
                ...
                List(users, id: \.id) { user in
                    // 🙋‍♀️ J'ai fait une liste de tous les users de l'appli. Pour l'améliorer, il faudrait retirer de cette liste les invités qui sont déjà dans Participants ou dans Non Participants. Mais si on le fait il ne restera plus personne ! Sinon, rajouter des users dans la DataBase ?
                    HStack {
